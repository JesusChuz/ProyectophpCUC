...
<body>
  ...
  <div class="regis">
      ...
      $sql = "INSERT INTO `empresas` (nombre, numero_telefono, correo, provincia, direccion, descripcion, password) VALUES ('$name', '$tele', '$email', '$provin', '$direcc', '$descri', '$password')";
      ...
      if ($conexion->query($sql) === TRUE) {
        ...
        echo "<br><br><button class='btn btn-primary mar'   onclick=location.href='login1.php'>Volver</button></p>";
      }
