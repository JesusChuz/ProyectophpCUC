...
<div class="container-fluid regis2">
  <div class="row">
  ...
  <div class="col-md-9 col-center">
      ...
      $oferente = $_SESSION['Cedula'];
      $acentos = $conexion->query("SET NAMES 'utf8'");
      $result = $conexion->query("SELECT * FROM solicitudes s, empleos_disp e WHERE s.cedula='$oferente' AND s.id_empleo=e.id_empleo")or die($mysqli->error);
      
      
      //
    
      while($empleo = $result->fetch_assoc()):?>
    
    <div class="row tr">
    <div class="col-md-3 mar vr col-center">
        <div id="titulos">
            <h1>
                <?=$empleo['puesto']?>
            </h1>
        </div>
        <div class="tr" id="divDetalles">
            <a style="padding-left: 40px; background: url(img/checked.png) no-repeat scroll 7px 7px;" class="lblDatos">
                <?=$empleo['requsitos']?>
            </a>
        </div>
        <div class="tr" id="divDetalles">
            <a style="padding-left: 40px; background: url(img/puesto.png) no-repeat scroll 7px 7px;" class="lblDatos">
                <?=$empleo['puesto']?>
            </a>
        </div>
        <div class="tr" id="divDetalles">
            <a style="padding-left: 40px; background: url(img/salario.png) no-repeat scroll 7px 7px;" class="lblDatos">
                <?=$empleo['salario'] ? $empleo['salario']:'' ?>
            </a>
        </div>
    </div>
    <div class="col-md-9 tr col-center cl">
      <br>
