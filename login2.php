<html lang="en">
	...
	<body>
		...
		<div class="login">
			...
			<form action="veri3.php" method="post" >
				<div class="vr clogin">
					<p class="posi"><label>Usuario:</label></p>
					<p><input class="form-control m-auto" name="user" type="text" id="user" required></p>
			...
			<br><button class="btn btn-primary mar bt " onclick=location.href='rempresas.php'>Registrarse</button>
		</div>
