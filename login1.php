<html lang="en">
	...
	<body>
		...
		<div class="login">
			...
			<form action="veri2.php" method="post" class="col-center" >
				<div class="vr clogin">
					<p class="posi"><label>Cédula:</label></p>
					<p><input class="form-control m-auto" name="Cedula" type="text" id="Usuario" required></p>


					<p class="posi"><label>Contraseña:</label></p>

					<p><input class="form-control m-auto" name="password" type="password" id="password" required></p>

					<p><input  class="btn btn-primary mar " type="submit" name="Submit" value="Iniciar"></p>
				</div>
				
			</form>
          	<br><button  class="btn btn-primary mar bt "  onclick=location.href='rusuaris.php'>Registrarse</button>
		</div>
