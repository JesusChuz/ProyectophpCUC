...
<body>
  ...
  <div class="login col-center">
      ...
      $sql = "SELECT * FROM `oferente` WHERE cedula = '$username'";
      ...
      if ($result->num_rows > 0) {
       ...
       if ($password==$row['password'])
       {
          ...
          ?>
          <form action="oferente3.php" method="post" >
            <br>
            <input class="form-control form-control-md" name="user" type="hidden" id="user" value="<?php echo $username; ?>"> 
            <br>
