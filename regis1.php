...
<body>
  ...
  <div class="regis">
      ...
      $sql = "INSERT INTO `oferente` (cedula, password, nombre, apellido1, apellido2, correo, provincia, direccion, numeroT) VALUES ('$cedula', '$password', '$name', '$apellido1', '$apellido2', '$email', '$provin', '$direcc', '$tele')";
    	$sql2= "INSERT INTO `DatosProfesionales` (cedula) VALUES ('$cedula')";
      if ($conexion->query($sql) === TRUE && $conexion->query($sql2) === TRUE) {
        echo "<h2>¡Registrado con exito!</h2>";
        echo "<br><br><button class='btn btn-primary mar' onclick=location.href='index.html'>Inicio</button></p>";
      } else {
  ...
  <div class="container-fluid bg-info foot"> <!--Footer-->
          <div class="row">
            <div class="mar col-12 foot ">
